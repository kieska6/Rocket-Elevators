...
class ElevatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elevator" do
    assert_difference('Elevator.count') do
      post elevators_url, params: { elevator: { certificate_of_inspection: @elevator.certificate_of_inspection, columnid: @elevator.columnid, date_of_commissioning: @elevator.date_of_commissioning, date_of_last_inspection: @elevator.date_of_last_inspection, information: @elevator.information, model: @elevator.model, notes: @elevator.notes, serial_number: @elevator.serial_number, status: @elevator.status, type_of_building: @elevator.type_of_building } }
    end
  ...
  test "should update elevator" do
    patch elevator_url(@elevator), params: { elevator: { certificate_of_inspection: @elevator.certificate_of_inspection, columnid: @elevator.columnid, date_of_commissioning: @elevator.date_of_commissioning, date_of_last_inspection: @elevator.date_of_last_inspection, information: @elevator.information, model: @elevator.model, notes: @elevator.notes, serial_number: @elevator.serial_number, status: @elevator.status, type_of_building: @elevator.type_of_building } }
