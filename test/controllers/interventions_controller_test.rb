...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { author: @intervention.author, battery_id: @intervention.battery_id, building_id: @intervention.building_id, column_id: @intervention.column_id, customer_id: @intervention.customer_id, elevator_id: @intervention.elevator_id, employee_id: @intervention.employee_id, intervention_end_date_time: @intervention.intervention_end_date_time, intervention_start_date_time: @intervention.intervention_start_date_time, report: @intervention.report, result: @intervention.result, status_opt: @intervention.status_opt } }
    end
