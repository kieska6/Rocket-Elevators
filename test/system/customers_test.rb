...
class CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Company email", with: @customer.company_email
    fill_in "Company headquarter", with: @customer.company_headquarter
    fill_in "Company name", with: @customer.company_name
    fill_in "Customer creation date", with: @customer.customer_creation_date
    fill_in "Service technical authority email", with: @customer.service_technical_authority_email
    fill_in "Service technical authority name", with: @customer.service_technical_authority_name
