...
class InterventionsTest < ApplicationSystemTestCase
  ...
  test "creating a Intervention" do
    ...
    fill_in "Intervention end date time", with: @intervention.intervention_end_date_time
    fill_in "Intervention start date time", with: @intervention.intervention_start_date_time
    fill_in "Report", with: @intervention.report
    fill_in "Result", with: @intervention.result
    fill_in "Status opt", with: @intervention.status_opt
